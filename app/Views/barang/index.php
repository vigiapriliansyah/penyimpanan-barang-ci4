    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="#" class="btn btn-info btn-sm" data-toggle="modal" data-target="#barangMasukModal<?= $b['id_barang']; ?>">Barang Masuk</a>

                <!-- Modal Barang Masuk -->
                <div class="modal fade" id="barangMasukModal<?= $b['id_barang']; ?>" tabindex="-1" aria-labelledby="barangMasukModalLabel" aria-hidden="true">
                            ...
                            <form action="/barang/barangMasuk/<?= $b['id_barang']; ?>" method="POST">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stok_masuk" id="stok_masuk" class="form-control" required min="1" value="1">
                                    </div>
                                </div>
                ...
                <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#barangKeluarModal<?= $b['id_barang']; ?>">Barang Keluar</a>

                <!-- Modal Barang Keluar -->
                <div class="modal fade" id="barangKeluarModal<?= $b['id_barang']; ?>" tabindex="-1" aria-labelledby="barangKeluarModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                            ...
                            <form action="/barang/barangKeluar/<?= $b['id_barang']; ?>" method="POST">
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="stok_keluar" id="stok_keluar" class="form-control" required min="1" value="1">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
